  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.pass}>
        ...
        >
          <Image
            style={{ width: 320, height: 190, resizeMode: "contain" }}
            source={imageUri}
          />
        </TouchableOpacity>
      </View>
      <View style={styles.navButtons}>
        <View style={styles.row1}>
          ...
          <TouchableOpacity
            style={[styles.button, { backgroundColor: "#C38D9E" }]}
          >
        ...
        <View style={styles.row2}>
          <TouchableOpacity
            style={[styles.button, { backgroundColor: "#EDF5E1" }]}
          >
            <MaterialIcons name="forum" size={30} color="black" />
            <Text>Forumn</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.button, { backgroundColor: "#B1A296" }]}
          >
...
export default function ProfileScreen(){
    ...
    return(
        <View style = {styles.container}>
            ...
            <View style = {styles.navButtons}>
                <View style = {styles.row1}>
                    <TouchableOpacity onPress={IpptIns} style={[styles.button, {backgroundColor:"#E27D60"}]}  >
                        <FontAwesome5 name="running" size={30} color="black" />
                        <Text>IPPT</Text>
                    </TouchableOpacity>
